                ...
                <form method="">
                    <div className="row">
                        <div className="col-md-4">
                            <img src={visitingUser.profilePic} width="50%" className="m-3" />
                        </div>
                        <div className="col-md-6">
                            <div className="profile-head">
                                <h5>{visitingUser.firstname} {visitingUser.lastname}</h5>

                                {followStat(user, visitingUser.username)}
                                
                                <p className="profile-rating mt-3 mb-5">Web Developer</p>
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="profile-work">
                                <p style={{fontWeight:"bold"}}>Selected Categories</p>
                                {visitingUser.category.map((elem) => {
                                    return(
                                        <>
                                        <Link style={{textTransform:"capitalize"}} to={"/" + elem} target="_sayak">{elem}</Link> <br/>
                                        </>
                                    )                                                             
                            })}                       
                            </div>
                                ...
                                <div className="tab-content profile-tab" id="myTabContent">
                                    <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
                                        ...
                                        <div className="row mt-3">
                                            ...
                                            <div className="col-md-6">
                                                <label>{visitingUser.firstname} {visitingUser.lastname}</label>
                                            </div>  
                                        </div>
                                        ...
                                        <div className="row mt-3">
                                            ...
                                            <div className="col-md-6">
                                                <label style={{cursor:"pointer"}}>{visitingUser.followers.length}</label>
                                            </div>  
                                        </div>

                                        <div className="row mt-3">
                                            <div className="col-md-6">
                                            <label style={{fontWeight:"bold"}}>Following</label>
                                            </div>  
                                            <div className="col-md-6">
                                                <label style={{cursor:"pointer"}}>{visitingUser.following.length}</label>
                                            </div>  
                                        </div>
