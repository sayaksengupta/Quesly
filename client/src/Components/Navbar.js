                ...
                {!searchToggle ? (                
                  ...
                  searchResults.filter((user) => {
                    ...
                    >
                      ...
                      <Link style={{textDecoration:"none",color:"#000"}} to= {{pathname : "/visiting-profile",state : {User : user, visitingUser : users}}}>
                      <h6
                        style={{
                          marginBottom: "0",
                          paddingLeft: "0.5rem",
                   ...
                   : 
                  <img src= {spinner} style={{width:"100%",textAlign:'center'}}></img>
                  }
