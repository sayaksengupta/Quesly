...
function Education() {
  ...
  const username = User.username;
    ...
    const [educationQueries, setEducationQueries] = useState([]);
    ...
    const CategoryCheck = () => {
      ...
      const inputAnswer = (e,id) => {
        setUserAnswer({...userAnswer, answer:e.target.value, id:id, username:user.username,profilePic: user.profilePic});
      }
   ...
   useEffect(() => {
    fetchEducationQueries();
    }, [callApi || loadAnswers]);

    console.log(educationQueries);
    ...
    return (
        ...
        {token ? (
          <>
          <Navbar />
            <div style={{ background: "#f1f2f2",minHeight:"100vh",maxHeight:"max-content" }} class="container-fluid">
            <div id="home-wrapper" class="row">
              ...
              <div id="questionWrapper" class="col-12 col-md-6 col-lg-6">
                ...
                {educationQueries.map((elem, index) => {
                  return (
                        ...
                        <div id="user-outer">
                          <div id="user_info">
                            ...
                            <div>
                              ...
                              ><Link style={{textDecoration:"none",color:"#000"}} to= {{pathname : "/visiting-profile",state : {User : user, visitingUser : elem}}}>
                                <h4
                                  style={{
                                    marginBottom: "0",
                                    paddingLeft: "1rem",
                                    ...
                                    >
                                      ...
                                      >
                                        <div id="answer_user_img_container">
                                          <img id="answer_user_img" src={element.profilePic} />
                                        </div>
                                        <h5
                                          style={{
                                            marginBottom: "0",
