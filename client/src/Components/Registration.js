          ...
          <>
            ...
            >
              ...
              {profileModal ? (
                ...
                <i class="fa fa-times" aria-hidden="true" style={{fontSize: "1.55rem",color:"#808080",cursor:"pointer"}} onClick={() => setProfileModal(false)}></i>
                </div>
                <hr style={{width:"100%"}}></hr>

                <div className="profileUpload">
                <input type="file" id="rgba" onChange={handleProfileChange} />
                {profileImg? <p>{profileImg.name}</p> : null}
                {loader ? <div class="loader"></div> : null}
                </div>

                <div className="submitProfile">
                  <button className="btn btn-primary" style={{width:"8rem"}} onClick={handleProfileUpload}>Upload</button>
                </div>
